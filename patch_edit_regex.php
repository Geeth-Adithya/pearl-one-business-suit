...
$pattern = '/<div>\s*<label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Description<\/label>\s*<textarea name="description" rows="3"\s*class="mt-1 block w-full border-black dark:border-gray-600 rounded-md shadow-sm bg-gray-50\s*dark:bg-gray-700 text-gray-900 dark:text-white px-3 py-2">.*?<\/textarea>\s*<\/div>/is';
...
echo "Added stock quantity and unit using regex.\n";
?>
