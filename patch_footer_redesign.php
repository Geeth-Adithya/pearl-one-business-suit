...
$startMarker = '<!-- Floating Contact Button & Modal -->';
$endMarker = '<script src="<?= BASE_URL ?>/assets/js/app.js?v=<?= time() ?>"></script>';
...
HTML;
    ...
    $content = $before . $newWidget . "\n" . $after;
    file_put_contents($file, $content);
    echo "Replaced contact modal with updated design.\n";
} else {
    echo "Error finding markers in footer.php\n";
}
?>
