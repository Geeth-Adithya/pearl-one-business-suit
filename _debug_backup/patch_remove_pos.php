...
$content = str_replace('<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">', '<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">', $content);

file_put_contents($file, $content);
echo "Removed POS from superadmin dashboard\n";
?>
