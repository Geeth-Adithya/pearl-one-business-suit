...
// Add fields to Quick Create Admin Form
$pattern = '/<label for="username".*?<input type="text" name="username" id="username" required.*?<\/div>/s';
...
echo "Patched admin/index.php\n";

$file2 = 'admin/manage_admins.php';
$content2 = file_get_contents($file2);

$content2 = str_replace('Add Admin', 'Add Shop', $content2);
$content2 = str_replace('Create New Admin', 'Create New Shop', $content2);
$content2 = str_replace('Manage Admins', 'Manage Shops', $content2);
$content2 = str_replace('Existing Admins', 'Existing Shops', $content2);

$pattern2 = '/<div>\s*<label for="username".*?<input type="text" name="username" id="username" required.*?<\/div>/s';
$replacement2 = <<<HTML
            <div>
...
HTML;
// I need to remove my PREVIOUS patch to manage_admins.php which added shop_name, etc.
// Wait, my previous patch added it BEFORE 'password'. Let's just restore from git or strip it out.
PHP;
?>
